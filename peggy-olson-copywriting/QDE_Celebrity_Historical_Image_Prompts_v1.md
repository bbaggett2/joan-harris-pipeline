...
## FEATURED_PROMPT
The click image (square "E" layout). After it is made, the workflow automatically centers this square on a wide 1536 x 1024 navy canvas so the blog card never cuts off words (see SOP v3).
