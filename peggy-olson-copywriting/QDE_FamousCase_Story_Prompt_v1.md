...
>
> **Superseded by [`QDE_FamousCase_Story_Prompt_V3.md`](./QDE_FamousCase_Story_Prompt_V3.md) and
> [`Headline-QDE-Post.md`](./Headline-QDE-Post.md) on 2026-09-15.** Kept as the record of how the process worked
> before research and copy were split into separate steps.
>
> **Two things below are now actively wrong:**
>
> 1. **Step 1a tells you to get case facts from RICK.** Research is now
>    [`QDE_FamousCase_Research_Prompt_v1.md`](./QDE_FamousCase_Research_Prompt_v1.md), which requires two independent
>    sources for any number, date or sentence length. RICK's relay of a source is a lead, not a source.
> 2. **Step 5 claims all twenty columns.** So did Research Prompt §6. Two files owning the same fields is what caused
>    QDE-FC-16 … FC-21 to stall half-filled on 2026-09-15. V3 has the column ownership table that settles it.
>
> Step 4 (fact discipline) is also duplicated in the Research Prompt, which owns it now.
