...
**Default path:** Path A, generated host — `HU_Thumbnail_Creation_Process_v5.md`
**Shared constants:** `HU_Thumbnail_Constants_v1.md` — applies to both paths, do not fork
**Extracted from:** `SOP_HU_IG_Screenshot_Torn_Paper_v2.md` §2 and §10, 2026-08-14. Values unchanged.
**Lives at:** `salvatore-art-department/HU_PathB_Frame_Acquisition_v1.md`
...
> `HU_Thumbnail_Constants_v1.md` and is identical on both paths.
>
...
Then apply the clearance test from `HU_Thumbnail_Constants_v1.md` §4 — lowest tooth versus
...
> Path A, generate at the target aspect ratio instead — v5 §0.5 Step 2 forbids padding a
...
- Every constant in `HU_Thumbnail_Constants_v1.md` §1
...
3. **Retire `SOP_HU_IG_Screenshot_Torn_Paper_v2.md`.** Its content is now split between
   `HU_Thumbnail_Constants_v1.md` (most of it) and this file (§2, §10). Leaving the original in
