...
This exists because the QDE lane's title file became a competing authority — it contradicted the governing prompt on title length and on strategy, and had to be pulled out of the system prompt. Do not let this file grow rules.
