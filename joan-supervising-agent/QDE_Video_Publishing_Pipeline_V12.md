...
**LinkedIn URN corrected.** V11 listed `urn:li:organization:91412902` (the company page).
The live Metricool account, read 2026-09-12, shows the QDE brand's LinkedIn connection as
`urn:li:person:nFfhG_fIiZ` — **Bart's personal profile**. Any LinkedIn post created through
Metricool for this brand lands on the personal profile. The company page is not connected
to this brand; a company-page reshare is a manual step or needs a second Metricool brand.
Metricool `userId` recorded. That is the only change — every rule, phase and open question
is identical to V11.

<details>
<summary><strong>What changed in V11</strong> (kept as history)</summary>
