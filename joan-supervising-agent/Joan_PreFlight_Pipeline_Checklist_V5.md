# Joan Pre-Flight Pipeline Checklist — V5

**Owner:** Joan Harris
**Version:** V5 — matches the filename. Highest number is current.
**Last updated:** 2026-09-12
**Status:** AUTHORITATIVE — supersedes V4
...
> revision becomes `..._V6.md` and this file is deleted in the same commit. Never two live.
>
